...
from .views import BusChatView, BusChatDetailView, BusChatContribAnalyzeView, BusResultListView, BusResultDetailView
...
urlpatterns = [
    ...
    path('chat/<int:chat_id>/analyze/contrib/', BusChatContribAnalyzeView.as_view()),  # Assuming you want to analyze a specific chat by ID
