...
urlpatterns = [
    ...
    path('quiz/some/<int:result_id>/personal/<str:name>/', PlaySomeQuizPersonalView.as_view()),
    ...
    path('quiz/some/<int:result_id>/submit/<str:name>', PlaySomeQuizSubmitView.as_view()),
    ...
    path('quiz/mbti/<int:result_id>/personal/<str:name>/', PlayMBTIQuizPersonalView.as_view()),
    ...
    path('quiz/mbti/<int:result_id>/submit/<str:name>', PlayMBTIQuizSubmitView.as_view()),
]