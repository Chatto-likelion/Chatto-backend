...
class ResultPlayChemSpec(models.Model):
    ...
    chatto_levelup1= models.TextField(default="")
    chatto_levelup_tips1 = models.TextField(default="")
    chatto_levelup2= models.TextField(default="")
    chatto_levelup_tips2 = models.TextField(default="")
    chatto_levelup3= models.TextField(default="")
    chatto_levelup_tips3 = models.TextField(default="")
